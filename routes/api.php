...
// all routes that needs the cors middlewares added
    ...
    Route::get('get_user_dogecoin_address/{user_id}', [ApisUserController::class, 'get_user_dogecoin_address']);
     ...
     //bitcoin
    Route::post('create/bitcoin/wallet', [BitconWalletController::class, 'CreateBitcoinWallet']);
   ...
   Route::post('create/create/gift/card', [GiftcardController::class, 'CreateGiftCard']);
