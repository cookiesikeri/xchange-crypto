<div class="modal fade" id="defaultModal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form  action="{{ route('cms.store', ['page' => 'activitytype']) }}" method="POST" enctype="multipart/form-data">
                {{csrf_field()}}
                ...
                <div class="row clearfix">
                    <div class="col-sm-12">
                        <div class="form-group">
                            <div class="form-line">
                                <input type="text" class="form-control" placeholder="Title" required name="name"/>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-12">
