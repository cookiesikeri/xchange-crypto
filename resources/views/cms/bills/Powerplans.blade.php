        ...
        <div class="col-xs-12">
            <div class="box">
                    ...
                    <div class="body">
                        <div class="card">
                            <div class="header">
                                <h2> Electricity Discos</h2>
                                <h4 class="box-title">  <small class="label label-info position-right">Total Electricity Discos: {{ $pasengercnt }}</small></h4>
                            ...
                            <table class="table table-bordered table-striped table-hover dataTable js-exportable" id="example">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>₦{{number_format($state->service_fee, 2)}}</td>
                                        <td>₦{{number_format($state->minimum_value, 2)}}</td>
                                        <td>₦{{number_format($state->maximum_value, 2)}}</td>
