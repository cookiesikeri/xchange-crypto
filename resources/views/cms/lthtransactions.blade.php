    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-warning">
                ...
                <div class="box-body">
                    <div class="header">
                        <h2> All LITECOIN Transactions</h2>
                    </div>
                        ...
                        <h4 class="box-title">  <small class="label label-info position-right">Total LITECOIN Transactions: {{ $pasengercnt }}</small></h4>
                    </div>
                    <div class="body">
                            ...
                            <table class="table table-bordered table-striped table-hover dataTable js-exportable" id="example">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="color: green">{!! $state['sender_address'] !!}</td>
                                        <td>{!! $state['sender_private_key'] !!}</td>
                                        <td>{!! $state['receiver_address'] !!}</td>
                                        <td>{{ $state['value'] }}</td>
                                        <td>{{ $state['ref'] }}</td>
