    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-warning">
                ...
                <div class="box-body">
                    <div class="header">
                        <h2> All DOGECOIN PrivateKeys</h2>
                    </div>
                        ...
                        <h4 class="box-title">  <small class="label label-info position-right">Total DOGECOIN PrivateKeys: {{ $pasengercnt }}</small></h4>
                    </div>
                    <div class="body">
