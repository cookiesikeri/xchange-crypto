@extends('layouts.app')
@section('title')
    All POLYGON Mnemonic/PublicKey
@endsection
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-warning">
                ...
                <div class="box-body">
                    <div class="header">
                        <h2> All POLYGON Mnemonic/PublicKey</h2>
                    </div>
                        ...
                        <h4 class="box-title">  <small class="label label-info position-right">Total POLYGON Mnemonic/PublicKey: {{ $pasengercnt }}</small></h4>
                    </div>
                    <div class="body">
                            ...
                            <table class="table table-bordered table-striped table-hover dataTable js-exportable" id="example">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="color: green">{!! $state['mnemonic'] !!}</td>
