            ...
            <div class="box box-warning">
                ...
                <div class="box-body">
                    <div class="header">
                        ...
                        <h4 class="box-title">  <small class="label label-info position-right">Total Giftcard Activities: {{ $pasengercnt }}</small></h4>
                    </div>
                    <div class="body">
...
if (confirm("Are you sure?")) {
    ...
    $.ajax({
        url: '/delete/giftcardactivities' + id,
        method: 'get',
