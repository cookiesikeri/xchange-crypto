    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-warning">
                ...
                <div class="box-body">
                    <div class="header">
                        <h2>Todays Registered users in the system </h2>
                        ...
                        {{-- <h4 class="box-title">  <span class="badge badge-info position-right">Total Passengers: {{ \App\Models\User::all()->where('account_type', '["passenger"]')->count() }}</span></h4> --}}
                        <h4 class="box-title">  <span class="label label-info position-right">Todays Users: {{ $pasengercnt }}</span></h4>
                    </div>
                    <div class="body">
