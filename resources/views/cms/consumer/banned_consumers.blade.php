    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-warning">
                ...
                <div class="box-body">
                    <div class="header">
                        <h2> All Banned Users in the system </h2>
                        ...
                        <h4 class="box-title">  <span class="label label-info position-right">Total Banned Users: {{ $pasengercnt }}</span></h4>
                    </div>
                    <div class="body">
                            ...
                            <table class="table table-bordered table-striped table-hover dataTable js-exportable" id="example">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('cms.unban.user', ['id' => $state->id])}}">
